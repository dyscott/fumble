...
class _ChatPageState extends State<ChatPage> {
  ...
  void _fetchChatUsers() {
    ...
    List<ChatUser> users = [
      ChatUser(name: 'Person 1', avatarUrl: 'https://media.discordapp.net/attachments/1181082647833890876/1202646104345284648/cowgan.png?ex=65d770f7&is=65c4fbf7&hm=c923634fe9f009750a1b65cef2588b8a0321b1511d00da2a0af949ace819b999&=&format=webp&quality=lossless&width=1536&height=1024'),
...
class ChatScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Simulated chat history with sender information
